...
class SportsCalendarEditPanel extends Q\Control\Panel
{
    public $dlgModal1;
    public $dlgModal2;
    public $dlgModal3;
    ...
    protected $strTemplate = 'SportsCalendarEditPanel.tpl.php';
    ...
    /**
     * Creates and configures two Toastr notification dialogs for success and error messages.
     *
     * @return void
     */
    ...
    /**
     * Handles the event when a status item is clicked. This function updates the selected value
     * and status of menu content and event settings, and manages the visibility of dialog boxes.
     *
