<?php
     ...
     */
    class BoardOptionsPanel extends Panel
    {
        ...
        /**
         * Constructs a new instance of the class, initializing components and handling session-based user tracking.
         *
         * This method sets up session-related data, such as the logged-in user ID, and prepares the necessary
         * sorters, inputs, buttons, modals, and toast notifications. It also attempts to call the parent constructor
         * and captures any exceptions encountered, adjusting their offset and rethrowing them if necessary.
         *
         * @param mixed $objParentObject Reference to the parent object for this control.
         ...
         */
        public function Sorter_Draw(BoardOptions $objBoardOptions): array
        {
         ...
         *
         * @return string The rendered status board list if the IDs match, or the activity status object otherwise.
         * @throws Caller
         */
        public function Inputs_Draw(BoardOptions $objBoardOptions): string
        {
         ...
         * The change button triggers an Ajax control action on a click.
         *
         ...
         * @throws Caller
         */
        public function Buttons_Draw(BoardOptions $objBoardOptions): string
        {
            if ($objBoardOptions->Id == $this->intChangeId) {
        ...
        public function createInputs(): void
        {
            ...
            $this->lstStatusBoard->addAction(new Change(), new AjaxControl($this, 'lstStatusBoard_Change'));
        }
        ...
        /**
         * Handles the change event of the image upload list dropdown and updates board settings
         * accordingly. It verifies CSRF tokens, updates database records, and displays appropriate
         * modal dialogs based on the selected values.
         *
         ...
         * @throws RandomException
         */
        protected function lstStatusBoard_Change(ActionParams $params): void
        {
            if (!Application::verifyCsrfToken()) {
                $this->dlgModal7->showDialogBox();
                $_SESSION['csrf_token'] = bin2hex(random_bytes(32));
