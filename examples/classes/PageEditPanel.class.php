...
class PageEditPanel extends Q\Control\Panel
{
    ...
    protected function createModals()
    {
        ...
        $this->dlgModal1->addAction(new Bs\Event\ModalHidden(), new \QCubed\Action\AjaxControl($this,'deleteItem_Click'));
    ...
    /**
     * Handles changes in class names and updates related objects based on menu content type.
     *
    ...
    protected function lstClassNames_Change(ActionParams $params)
    {
        ...
        if ($this->objMenuContent->ContentType == 3) { // News type
            ...
            $objNewsSettings->setNewsGroupId($this->objMenuContent->Id);
        ...
        if ($this->objMenuContent->ContentType == 11) { // Board type
            ...
            $objInputs = [
                ...
                ['input_key' => 3, 'name' => 'Areas responsibility', 'order' => 2, 'activity_status' => 2],
        ...
        if ($this->objMenuContent->ContentType == 12) { // Members type
        ...
        if ($this->objMenuContent->ContentType == 13) { // Videos type
     ...
     */
    private function lockInputFields()
    {
        ...
        $objGallerySettings->setPath('/' . QString::sanitizeForUrl($this->objMenuContent->getMenuText()));
     ...
     * @return void
     */
    protected function makeGallery($title)
    {
     ...
     * redirects to the list page upon successful operation, or provides user feedback through
