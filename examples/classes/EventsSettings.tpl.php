<div class="form-horizontal">
    ...
    <div class="row">
        <div class="table-top-heading">
            <span class="vauu-title-3"><?php _t('Event groups settings') ?></span>
        </div>
    </div>
    <div class="table-body">
        <div class="row">
            ...
            <div class="col-md-6" style="text-align: right; margin-bottom: 15px;"><?= _r($this->dtgEventsGroups->Paginator); ?></div>
        </div>
        <?= _r($this->dtgEventsGroups); ?>
        <div class="row">
            <div class="col-md-12">
                <?= _r($this->btnGoToEvents); ?>
                <?= _r($this->txtEventGroup); ?>
                <?= _r($this->txtEventTitle); ?>
                <?= _r($this->btnSave); ?>
                <?= _r($this->btnCancel); ?>
            </div>
        </div>
