...
<div class="form-horizontal">
    <div class="row">
        <div class="panel-heading" style="margin-top: -15px;">
            <span class="vauu-title-3"><?php _t('Age group gender distribution and management') ?></span>
        </div>
    </div>
                ...
                <div class="setting-wrapper hidden">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <?= _r($this->lblAthleteGender); ?>
                                <div class="col-md-5">
                                    <?= _r($this->lstAthleteGender); ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <?= _r($this->lblGender); ?>
