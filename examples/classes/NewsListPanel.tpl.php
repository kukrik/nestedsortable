...
<div class="form-horizontal">
    ...
    <div class="table-body">
        <div class="row" style="margin-top: -15px;">
            ...
            <div class="col-md-2 js-changes"><?= _r($this->lstChanges); ?></div>
            <div class="col-md-2 js-categories"><?= _r($this->lstCategories); ?></div>
        ...
        <div class="row">
            ...
            <div class="col-md-11" style="text-align: right; margin-top: 15px;"><?= _r($this->dtgNews->Paginator); ?></div>
        </div>
        <?= _r($this->dtgNews); ?>
        <div class="row">
