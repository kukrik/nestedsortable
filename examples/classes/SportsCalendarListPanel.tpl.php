...
<div class="form-horizontal">
    <div class="row">
        <div class="table-top-heading">
            <span class="vauu-title-3"><?php _t('Sports calendar manager') ?></span>
        </div>
    </div>
    <div class="row">
    ...
    <div class="table-body">
        <div class="row" style="margin-top: -15px;">
            ...
            <div class="col-md-2 js-sports-areas" style="width: 16%;"><?= _r($this->lstSportsAreas); ?></div>
        ...
        <div class="row">
            ...
            <div class="col-md-11" style="text-align: right; margin-top: 15px;"><?= _r($this->dtgSportsCalendars->Paginator); ?></div>
        </div>
        <?= _r($this->dtgSportsCalendars); ?>
        <div class="row">
            <div class="col-md-3"><?= _r($this->btnBack); ?></div>
            <div class="col-md-9" style="text-align: right;"><?= _r($this->dtgSportsCalendars->PaginatorAlternate); ?></div>
        </div>
    </div>
</div>