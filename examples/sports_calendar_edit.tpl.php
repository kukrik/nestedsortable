        ...
        <div class="col-md-12">
            <div class="content-body">
                <div class="panel-heading">
                    <h3 class="vauu-title-3 margin-left-0"><?php _t('Editing sports calendar') ?></h3>
                </div>
                    ...
                    <div class="form-horizontal" style="padding: 0 5px;">
                        <div class="row equal">
                            <div class="col-md-9 left-box padded-wrapper">
                                ...
                                <div class="form-group">
                                    <?= _r($this->lblInstructionLink); ?>
                                    <div class="col-md-9">
                                        <?= _r($this->btnInstructionLink); ?>
                                        <?= _r($this->txtInstructionLink); ?>
                                    </div>
                                    <div class="col-md-4">
                                        <?= _r($this->lstSportsContentTypes); ?>
                                    </div>
                                    <div class="col-md-4">
                                        <?= _r($this->calShowDate); ?>
                                    </div>
