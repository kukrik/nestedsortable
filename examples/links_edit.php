...
class SampleForm extends Form
{
    ...
    protected $lblDocumentLink;
    protected $btnDocumentLink;
    protected $lblFileName;
    protected $txtHiddenDocument;
    protected $btnSaveFile;
    protected $btnCancelFile;
    //protected $btnDeleteFile;
    ...
    protected function createInputs()
    {
        ...
        $countByLinkType = LinksSettings::countByLinkType($this->objLinksSettings->LinkType);

        $objGroups = LinksSettings::queryArray(
            QQ::Equal(QQN::LinksSettings()->LinkType, $this->objLinksSettings->LinkType),
        ...
        if ($countByIsReserved === 1 || $countByLinkType === 1) {
    ...
    protected function createButtons()
    {
        ...
        $this->btnDocumentLink->addAction(new Q\Event\Click(), new Q\Action\Ajax('btnDocumentLink_Click'));
        ...
        $this->btnSaveFile->addAction(new Q\Event\Click(), new Q\Action\Ajax('btnSaveFile_Click'));
        ...
        $this->btnCancelFile->addAction(new Q\Event\Click(), new Q\Action\Ajax('btnCancelFile_Click'));
     ...
     */
    protected function btnDocumentLink_Click(ActionParams $params)
    {
        $objLink = Links::load($this->intClick);

        $_SESSION["links"] = $this->intId;
        $_SESSION["links-group"] = $this->intGroup;
        ...
        Application::redirect('links_finder.php');
    }
     ...
     */
    protected function btnSaveFile_Click(ActionParams $params)
    {
        $objLink = $_SESSION["links-data"] ? $_SESSION["links-data"] : Links::load($this->intClick);
     ...
     * @return void
     */
    protected function btnCancelFile_Click(ActionParams $params)
    {
        if (!empty($_SESSION["data_id"]) || !empty($_SESSION["data_name"]) || !empty($_SESSION["data_path"])) {
