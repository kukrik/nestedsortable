...
class SampleForm extends Form
{
    ...
    protected function formCreate()
    {
        ...
        $this->objHomeLink->Text = Q\Html::renderLink("links_finder.php#/", "Repository", ["data-lang" => "repository"]);
    ...
    public function btnInsert_Click(ActionParams $params)
    {
        if ($this->arrSomeArray[0]["data-activities-locked"] == 1) {
            ...
            if (!empty($_SESSION["links"]) || !empty($_SESSION["links-group"])) {
                Application::redirect('links_edit.php?id=' . $_SESSION["links"] . '&group=' . $_SESSION["links-group"]);
            }

            unset($_SESSION["links"]);
            unset($_SESSION["links-group"]);
