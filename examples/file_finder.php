<?php
     ...
     */
    class FileFinderForm extends Form
    {
        ...
        protected Q\Plugin\Control\FileInfo $objInfo;
        ...
        protected function formCreate(): void
        {
            ...
            $this->objHomeLink->Text = Html::renderLink("file_finder.php#/", "Repository", ["data-lang" => "repository"]);
        ...
        public function btnInsert_Click(ActionParams $params): void
        {
            ...
            if ($this->arrSomeArray[0]["data-activities-locked"] == 1) {
                ...
                if (!empty($_SESSION["redirect-data"])) {
                    Application::redirect($_SESSION["redirect-data"]);
                }
    ...
    FileFinderForm::run('FileFinderForm');
