<?php
     ...
     *
     * This class represents a table that displays and manages age categories. It extends the VauuTable class and provides
     * mechanisms for handling data binding, column creation, pagination, and custom conditions. The class is designed to
     * work with the AgeCategories model and leverages QQN for querying and data representation.
     *
     * Key Features:
     * - Dynamically creates table columns for data representation.
     * - Supports data binding with dynamic conditions and clauses.
     * - Integrates pagination and sorting mechanisms.
     * - Provides flexibility to define custom query conditions and clauses.
     * - Leverages the QQN (query node) system for database querying.
     */
    class AgeCategoriesTable extends VauuTable
    {
        protected ?object $objCondition = null;
        protected ?array $objClauses = null;

        public object $colClassName;
        public object $colMinAge;
        public object $colMaxAge;
        public object $colDescription;
         ...
         * @param string|null $strControlId An optional control ID for identification.
         *
         * @return void
         * @throws Caller
         */
        ...
        /**
         * Creates and configures column objects for the display of age category data.
         * Each column corresponds to a property of the AgeCategories entity.
         *
         * The method defines columns, sets their widths, and applies additional configurations
         * such as disabling HTML entities for certain columns.
         *
         * @return void
         * @throws Caller
         * @throws InvalidCast
        ...
        public function createColumns(): void
        {
            ...
            $this->colLocking = $this->createNodeColumn(t("Lock status"), QQN::AgeCategories()->IsLockedObject);
