<?php
    ...
    /**
     * Class BoardSettingsTable
     *
     * Represents a data table for managing BoardSettings. Provides functionality to create and manage columns,
     * bind data, and handle conditions and clauses for querying data.
     */
    class BoardSettingsTable extends VauuTable
    {
        ...
        /**
         * Creates and initializes columns for the BoardsSettings table.
         *
         * This method defines various columns with specific properties such as width,
         * formatting, and HTML behavior. Each column corresponds to a particular field
         * in the BoardsSettings data structure.
         *
         * @return void
         * @throws Caller
         * @throws InvalidCast
        ...
        {
            $this->colName = $this->createNodeColumn(t("Menu text"), QQN::BoardsSettings()->Name);
            ...
            $this->colIsReserved = $this->createNodeColumn(t("Is reserved"), QQN::BoardsSettings()->IsReservedObject);
            $this->colIsReserved->HtmlEntities = false;
            //$this->colIsReserved->CellStyler->Width = '12%';

            $this->colStatus = $this->createNodeColumn(t("Status"), QQN::BoardsSettings()->StatusObject);
