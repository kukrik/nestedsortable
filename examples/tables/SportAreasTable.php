<?php
    ...
    /**
     * Class SportAreasTable
     *
     * Represents a table control for displaying sports areas related data. Extends the base VauuTable class and includes
     * mechanisms for condition-driven data binding and dynamic column creation.
     */
    class SportAreasTable extends VauuTable
    {
         ...
         *
         * @param mixed $objParent The parent object that controls the instance.
         * @param string|null $strControlId The optional ID of the control.
         *
         * @return void
         * @throws Caller
         */
        ...
        /**
         * Creates and configures columns for the SportsAreas data table.
         *
         * This method initializes and sets up several columns, including their
         * display names, sorting logic, formatting, and style attributes.
         *
         * @return void
         * @throws Caller
         * @throws InvalidCast
