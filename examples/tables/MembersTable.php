<?php
     ...
     */
    class MembersTable extends VauuTable
    {
         ...
         *
         * @param mixed $objParent The parent object that the control belongs to.
         * @param string|null $strControlId The optional control ID. If not provided, a unique ID will be generated.
         *
         * @return void
         * @throws Caller
         */
        ...
        /**
         * Creates and initializes column definitions for the MembersSettings entity.
         *
         * This method defines several columns with specific properties such as display titles,
         * formatting rules, column widths, and ordering clauses for the MembersSettings table.
         * It includes columns for group names, titles, statuses, image upload permissions,
         * creation and modification dates, and author details.
         *
         * @return void
         * @throws Caller
         * @throws InvalidCast
        ...
        {
            $this->colGroupTitle = $this->createNodeColumn("Member group", QQN::MembersSettings()->Name);
            ...
            $this->colStatusObject = $this->createNodeColumn(t("Status"), QQN::MembersSettings()->StatusObject);
            $this->colStatusObject->HtmlEntities = false;
            $this->colStatusObject->CellStyler->Width = '12%';

            $this->colImageUploadObject = $this->createNodeColumn(t("Image upload"), QQN::MembersSettings()->AllowedUploadingObject);
            ...
            $this->colPostDate->OrderByClause = QQ::orderBy(QQN::MembersSettings()->PostDate, false);
            $this->colPostDate->ReverseOrderByClause = QQ::orderBy(QQN::MembersSettings()->PostDate, true);
            ...
            $this->colAuthor = $this->createNodeColumn(t("Author"), QQN::MembersSettings()->Author);
        }
