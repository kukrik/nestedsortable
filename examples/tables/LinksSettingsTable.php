<?php
    ...
    /**
     * Class LinksSettingsTable
     *
     * This class represents a table control to display and manage "LinksSettings" data. It extends the VauuTable class
     * to provide additional functionality tailored for this specific data type. It includes methods for setting up columns,
     * data binding, and condition management.
     */
    class LinksSettingsTable extends VauuTable
    {
        ...
        /**
         * Creates and configures the columns used in the data grid or similar structure.
         * Each column is configured with a label, data source, and various display settings.
         *
