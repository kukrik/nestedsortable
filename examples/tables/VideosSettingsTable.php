<?php
    ...
    /**
     * Class VideosSettingsTable
     *
     * Represents a data table for managing VideosSettings. Provides functionality to create and manage columns,
     * bind data, and handle conditions and clauses for querying data.
     */
    class VideosSettingsTable extends VauuTable
    {
        ...
        /**
         * Creates and initializes columns with specific properties such as title, width, format, and HTML entities handling.
         * Each column is associated with a specific attribute of the VideosSettings object.
         *
         * @return void This method does not return a value, as it configures column properties directly.
         * @throws Caller
         * @throws InvalidCast
         */
        public function createColumns(): void
        {
            $this->colName = $this->createNodeColumn(t("Menu text"), QQN::VideosSettings()->Name);
            ...
            $this->colIsReserved = $this->createNodeColumn(t("Is reserved"), QQN::VideosSettings()->IsReservedObject);
            $this->colIsReserved->HtmlEntities = false;
            $this->colIsReserved->CellStyler->Width = '12%';

            $this->colStatus = $this->createNodeColumn(t("Status"), QQN::VideosSettings()->StatusObject);
