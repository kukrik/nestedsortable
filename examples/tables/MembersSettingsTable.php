<?php
    ...
    /**
     * Class MembersSettingsTable
     *
     * Represents a table for displaying and managing MemberSettings data.
     * Inherits functionalities from the VauuTable base class.
     */
    class MembersSettingsTable extends VauuTable
    {
        ...
        /**
         * Configures and creates the columns for displaying specific attributes
         * of the MembersSettings entity. Each column is associated with a
         * property or object and customized with specific formatting and styling.
         *
         * @return void
         * @throws Caller
         * @throws InvalidCast
