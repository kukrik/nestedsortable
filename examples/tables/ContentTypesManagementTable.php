<?php
    ...
    /**
     * The ContentTypesManagementTable class is responsible for rendering and managing a table
     * displaying content types from the ContentTypesManagement data model.
     * It extends the VauuTable class to inherit basic table functionality.
     */
    class ContentTypesManagementTable extends VauuTable
    {
        protected ?object $objCondition = null;
        protected ?array $objClauses = null;

        public object $colId;
        public object $colContentName;
         ...
         * @param string|null $strControlId The optional control ID to assign.
         *
         * @return void
         * @throws Caller
         */
        public function __construct(mixed $objParent, ?string $strControlId = null)
        {
            ...
            $this->watch(QQN::ContentTypesManagement());
        }

        /**
         * Creates and initializes the columns for the content types management.
         *
         * @return void
         * @throws Caller
         * @throws InvalidCast
        ...
        {
            $this->colId = $this->createNodeColumn(t("Id"), QQN::ContentTypesManagement()->Id);

            $this->colContentName = $this->createNodeColumn(t("Content name"), QQN::ContentTypesManagement()->ContentName);

            $this->colContentType = $this->createNodeColumn(t("Content type"), QQN::ContentTypesManagement()->ContentTypeObject);

            $this->colViewType = $this->createNodeColumn(t("View type"), QQN::ContentTypesManagement()->ViewTypeObject);
        }
        ...
        public function bindData(?QQCondition $objAdditionalCondition = null, mixed $objAdditionalClauses = null): void
        {
            ...
            if ($this->Paginator) {
                $this->TotalItemCount = ContentTypesManagement::queryCount($objCondition, $objClauses);
            }
            ...
            $this->DataSource = ContentTypesManagement::queryArray($objCondition, $objClauses);
        }
