...
class AthletesTable extends \QCubed\Plugin\Control\VauuTable
{
	...
	public function createColumns()
	{
        ...
        $this->colLocking = $this->createNodeColumn("Is locked", QQN::Athletes()->IsLockedObject);
        $this->colLocking->HtmlEntities = false;
        $this->colLocking->CellStyler->Width = '15%';

//        $this->colPostDate = $this->createNodeColumn(t("Created"), QQN::Athletes()->PostDate);
//        $this->colPostDate->Format = 'DD.MM.YYYY hhhh:mm';
//		$this->colPostDate->CellStyler->Width = '15%';
//
//        $this->colPostUpdateDate = $this->createNodeColumn(t("Modified"), QQN::Athletes()->PostUpdateDate);
