...
class SelectedSportsTable extends \QCubed\Plugin\Control\VauuTable
{
	...
	{
        $this->colContentType = $this->createNodeColumn(t("Content type"), QQN::SportsAreas()->SportsContentTypes);
        $this->colIsEnabled->CellStyler->Width = '20%';

        $this->colLink = $this->createCallableColumn(t('Document link'), [$this, 'View_render']);
        $this->colLink->HtmlEntities = false;
