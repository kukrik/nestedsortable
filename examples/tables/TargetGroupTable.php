<?php
    ...
    /**
     * Class CalendarTargetGroupTable
     *
     * Represents a table for displaying and managing calendar target group data.
     * This class extends the VauuTable and includes functionality to create, bind, and manage data columns.
     * It also handles dynamic condition and clause management for querying target group data.
     */
    class CalendarTargetGroupTable extends VauuTable
    {
        protected ?object $objCondition = null;
        protected ?array $objClauses = null;

        public object $colTargetGroup;
         ...
         * @param string|null $strControlId Optional ID for the control. If null, an ID will be generated automatically.
         *
         * @return void
         * @throws Caller
         */
        ...
        /**
         * Creates and configures the column definitions for the table representation.
         *
         * @return void
         * @throws Caller
         * @throws InvalidCast
        ...
        public function createColumns(): void
        {
            ...
            $this->colTargetGroup->CellStyler->Width = '30%';

            $this->colLockStatus = $this->createPropertyColumn(t("Lock status"), 'LockStatusObject');
            $this->colLockStatus->HtmlEntities = false;
            //$this->colLockStatus->CellStyler->Width = '17%';
            ...
            //$this->colIsEnabled->CellStyler->Width = '17%';
