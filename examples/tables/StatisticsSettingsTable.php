<?php
    ...
    /**
     * Class StatisticsSettingsTable
     *
     * Represents a data table for displaying and managing statistics settings.
     * Extends the base functionality of VauuTable to define specific configurations
     * for columns, data binding, and query conditions related to the StatisticsSettings entity.
     */
    class StatisticsSettingsTable extends VauuTable
    {
        ...
        /**
         * Creates and configures columns for statistics settings.
         *
         * Each column is initialized with specific attributes such as name, width, formatting,
         * and other display properties. This method sets up the columns that are displayed.
         *
         * @return void
         * @throws Caller
         * @throws InvalidCast
        ...
        {
            $this->colName = $this->createNodeColumn(t("Menu text"), QQN::StatisticsSettings()->Name);
            ...
            $this->colIsReserved = $this->createNodeColumn(t("Is reserved"), QQN::StatisticsSettings()->IsReservedObject);
            $this->colIsReserved->HtmlEntities = false;
            $this->colIsReserved->CellStyler->Width = '12%';

            $this->colStatus = $this->createNodeColumn(t("Status"), QQN::StatisticsSettings()->StatusObject);
