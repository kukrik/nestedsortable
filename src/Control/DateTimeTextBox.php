<?php
    ...
    {
        protected string $strMode = 'date'; // Possible values: 'date', 'datetime', 'time'
        protected string $strDateTimeFormat = "DD.MM.YYYY";
        protected ?QDateTime $dttDateTime = null;
        protected ?string $strLabelForInvalid = 'Invalid format.';
         ...
         *
         * @param null|string $strText The input text to parse for a datetime value. Can be null or an empty string.
         *
         * @return QDateTime|null Returns a QDateTime object if the text is successfully parsed, or null if the input is empty.
         * @throws DateMalformedStringException
         * @throws Caller
         */
        protected static function parseForDateTimeValue(?string $strText): ?QDateTime
        {
            if (empty($strText)) {
                return null;
            }
        ...
        public function validateFormat(): bool
        {
            ...
            if (str_contains($this->strDateTimeFormat, 'YY')) {
         ...
         */
        protected function expandShortYearFormat(mixed $inputValue, string $phpFormat): string
        {
            ...
            if (str_contains($phpFormat, 'y')) {
                ...
                if ($date) {
                    ...
                    // If the year is >= 50, then 19YY, otherwise 20YY
                ...
                case 'DateTime':
                    try {
                        ...
                        if (!$this->dttDateTime || !$this->strDateTimeFormat) {
                            ...
                            // Uses a full format with a static format (we add links)
