...
require ('FileUploadHandlerBaseGen.php');
...
class FileUploadHandler extends FileUploadHandlerBaseGen
{
    /** @var string[] */
    ...
    /**
     * Registers the necessary JavaScript and CSS files for the upload handler.
     *
     * @return void
     * @throws Exception if the assets could not be registered.
     */
    ...
    /**
     * Generates the HTML string for control elements related to file handling.
     *
     * @return string HTML string for file control elements.
     */
    ...
    /**
     * Sets up the storage directories and paths required for the application.
     *
     * @return void
     * @throws Caller If the root path or storage path is not writable or not found.
     */
    ...
    /**
     * Cleans the given path by removing unnecessary characters and ensuring a consistent format.
     *
