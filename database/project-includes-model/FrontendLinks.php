...
use QCubed\Query\Clause\ClauseInterface as iClause;
	...
	class FrontendLinks extends FrontendLinksGen {
		...
		/**
		 * Load FrontendLinks one object - Id,
		 * by LinkedId Index(es)
		 * @param integer $intFrontendId
		 * @param iClause[] $objOptionalClauses additional optional iClause objects for this query
		 * @return FrontendLinks->Id
		 */
		public static function loadByIdFromFrontedLinksId($intFrontendId, $objOptionalClauses = null)
		{
			// Use QuerySingle to Perform the Query
			$objToReturn = FrontendLinks::querySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::frontendLinks()->LinkedId, $intFrontendId)
				), $objOptionalClauses
			);
			return $objToReturn;
		}
